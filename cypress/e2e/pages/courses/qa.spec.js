...
describe('User navigation QA page', () => {
  devices.forEach((device) => {
    describe(`From navbar in ${device}`, () => {
      beforeEach(() => {
        ...
        cy.visit('/curso-quality-assurance.html');
